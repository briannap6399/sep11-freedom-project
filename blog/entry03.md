...
In a similar vein to what was said in the last blog, I think it's safe to say I'm in between Stage 3 of the EDP, also known as **Brainstorm Possible Solutions**, and Stage 4, also known as **Plan the most promising solution**. It's clear to me that the platformer is already set in stone for what my partner and I want to work on, but how it'll be structured is still up to debate. Based on what I've done so far, I already know I want to use a similar system like this to send the player into a scene of their choosing: One will take them directly to the game, while the other will possibly take them to a character setting scene? I've also further thought about how I want the actual questions to look. As a creator and someone who's currently learning Spanish, I already decided I wanted questions separated based on what they could offer to a player (Conjugation, Indefinite vs Definite Verbs, Masculine vs Feminine, etc), but I've also considered making a sort of intensity separator with the packs? Specifically, they are divided up based on their difficulty. This feels like a good plan, but I know for now I should absolutely focus on creating scenes with the click of a button. It seems like the best progression with what I have here so far!
